...
/// [`norn_graph_dealloc`].
#[unsafe(no_mangle)]
pub extern "C" fn norn_graph_alloc(len: usize) -> *mut u8 {
...
#[unsafe(no_mangle)]
pub extern "C" fn norn_graph_alloc_f32(count: usize) -> *mut f32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn norn_graph_alloc_u32(count: usize) -> *mut u32 {
