...
The base ELK layout is the current ground-truth anchor for browser motion. Combined
...
against blind graph-truth probes. It does not yet prove realtime sampling optimality.
The first realtime smoke baseline is generated by:
...
of the mock graph. The viewer's default profile mirrors that baseline. Do not call
the realtime heuristics "extensively tuned" until broader profiled budget sweeps
exist for real client corpora and their results are checked in.
